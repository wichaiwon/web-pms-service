...
export interface IVehicleServiceReviewServiceInterface {
    ...
    getIncompleteVehicleServiceReview(branch: Branch): Promise<VehicleServiceReviewDto[]>;
    getVehicleServiceReviewById(id: string): Promise<VehicleServiceReviewDto | null>;
    ...
    patchInProcess(id: string, patchInprocessDto: PatchVehicleServiceReviewInProcessDto): Promise<VehicleServiceReviewDto>;
