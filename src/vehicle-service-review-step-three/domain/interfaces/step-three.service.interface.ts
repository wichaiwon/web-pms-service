...
export interface IStepThreeServiceInterface {
    getStepThreeById(id: string): Promise<StepThreeDto | null>;
    ...
    createStepThrees(createDtos: CreateStepThreeDto[]): Promise<StepThreeDto[]>;
    ...
    getStepThreeAdditionalById(id: string): Promise<StepThreeAdditionalDto | null>;
    getStepThreeAdditionalByStepThreeId(stepThreeId: string): Promise<StepThreeAdditionalDto | null>;
